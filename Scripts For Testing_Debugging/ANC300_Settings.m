...
pathway_all_functions = "C:\Users\Quantum Dot\Desktop\Bera Yavuz - ANC300 Movement and Images\Scripts_&_Debugging_Tools";
...
Frequency_X = 20; % Possible options: 1 - 10000 (must be integer)
Voltage_X = 12; % Possible options: 1 - 150.0 (can be a float value)
...
Frequency_Y = 20; % Possible options: 1 - 10000 (must be integer)
Voltage_Y = 12; % Possible options: 1 - 150.0 (can be a float value)
