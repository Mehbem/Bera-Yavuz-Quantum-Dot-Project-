...
pause(0.5)
[StartingQD,~,Rotated_Table_FullQDList_sorted,Table_FullQDList_sorted] = MyFuncs.Precision_Locking_Matlab(ANC300,PhotoType,QD_counter,vid_UI,src_UI,40);
% --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
for column = 1: num_of_breaks_column
    ...
    pause(0.3)
    [StartingQD,~,Rotated_Table_FullQDList_sorted,Table_FullQDList_sorted] = MyFuncs.Precision_Locking_Matlab(ANC300,PhotoType,QD_counter,vid_UI,src_UI,fast_movement_margin);
...
for column_remaining = 1: remaining_QD_column
   ...
   [StartingQD,~,Rotated_Table_FullQDList_sorted,Table_FullQDList_sorted] = MyFuncs.Precision_Locking_Matlab(ANC300,PhotoType,QD_counter,vid_UI,src_UI,locking_on_margin);
...
for row = 1:num_of_breaks_row
    ...
    pause(0.3)
    [StartingQD,~,Rotated_Table_FullQDList_sorted,Table_FullQDList_sorted] = MyFuncs.Precision_Locking_Matlab(ANC300,PhotoType,QD_counter,vid_UI,src_UI,fast_movement_margin); % trying to land on the exact dot 
...
for row_remaining = 1: remaining_QD_row
   ...
   [StartingQD,~,Rotated_Table_FullQDList_sorted,Table_FullQDList_sorted] = MyFuncs.Precision_Locking_Matlab(ANC300,PhotoType,QD_counter,vid_UI,src_UI,locking_on_margin); % trying to land on the exact dot 
end

% final check to make sure exactly on dot 
MyFuncs.Precision_Locking_Matlab(ANC300,PhotoType,QD_counter,vid_UI,src_UI,fast_movement_margin);

% Spectroscope Image and Plot
[Emission_Reading_Img,pks,plot_img] = ASI_Snap_Img(vid_ASI,src_ASI,"Spectrometer","Yes",1800,QD_counter,"");
