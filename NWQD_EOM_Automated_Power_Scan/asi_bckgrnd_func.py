...
def snap_background(asi_initialization_return):
    ...
    qd_data_directory = r"c:\Users\Quantum Dot\Desktop\Bera Yavuz - ANC300 Movement and Images\c:\Users\Quantum Dot\Desktop\Bera Yavuz - ANC300 Movement and Images\Scripts_&_Debugging_Tools\NWQD_EOM_Automated_Power_Scan\NWQD_Power_Scan_Data"
    ...
    os.chdir(qd_data_directory) 

    filename = 'background_1200mm_grating_'+date_string
